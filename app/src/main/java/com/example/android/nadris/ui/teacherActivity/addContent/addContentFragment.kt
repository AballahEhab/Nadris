...
import com.example.android.nadris.ui.teacherActivity.addSection.REQUEST_AUDIO_PERMISSION_CODE
...
class addContentFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == com.example.android.nadris.ui.teacherActivity.addContent.OPEN_DOCUMENT_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            data?.data?.let { uri ->
                openDocument(uri)
            }
        }
    ...
    binding.video.setOnClickListener{
        ...
        binding.textEditor.setOnClickListener {
            binding.uploadPDF.visibility=View.GONE
            val action = addContentFragmentDirections.actionAddContentFragmentToTextEditorFragment()
            findNavController().navigate(action)
...
private fun openDocumentPicker() {
    ...
    startActivityForResult(
        intent,
        com.example.android.nadris.ui.teacherActivity.addContent.OPEN_DOCUMENT_REQUEST_CODE
    )
}
